...
# Overview
This is the final report for Coursera’s Practical Machine Learning course.
...
We can now separate the training set into a **validation** and sub **training** set after we've removed all of the extraneous variables. The "testcsv" testing set will be left alone and will be utilized for the final quiz test cases.
```{r}
...
We'll put a few common models to the test, including Decision Trees, Random Forests, Gradient Boosted Trees, and SVMs. This is definitely more than we'll need to test, but we'll run them for comparison out of curiosity and good practice.

Set up a 3-fold cross validation control for training.
```{r}
...
Github Repo: [Github](https://github.com/khoirulakmal/Course_Project_Practical_Machine_Learning)
